...
class AllOrderFragment : Fragment() {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (data in snapshot.children) {
                    ...
                    if (data.child("status").value?.equals("In cart") != true
                        ...
                        val dbRef2 =
                            FirebaseDatabase.getInstance().getReference("Bill/${data.key}/products")
                ...
                //set animation
                val layoutAnim =
                    AnimationUtils.loadLayoutAnimation(context, R.anim.layout_anim_left_to_right)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        allOrderAdapter = AllOrderAdapter(mutableListOf())
        rvOrderList.adapter = allOrderAdapter
